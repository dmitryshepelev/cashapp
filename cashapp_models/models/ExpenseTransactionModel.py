...
class ExpenseTransaction(ModelBase, TransactionModelBase):
	...
	def create_register_record(self):
		...
		"""
		previous_register_record = self.payment_object.get_last_register_record()
		...
		PORegister.objects.update_register_values(self.payment_object.guid, self.get_total_value(), False, register_record.date)
