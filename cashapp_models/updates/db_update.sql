...
ALTER TABLE "cashapp_models_category" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.560000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_category" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_category" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.593000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_category" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_categorylevel" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.640000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_categorylevel" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_categorylevel" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.672000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_categorylevel" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_currency" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.704000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_currency" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_currency" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.738000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_currency" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expenseitem" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.771000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expenseitem" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expenseitem" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.805000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expenseitem" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expenseitemregister" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.837000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expenseitemregister" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expenseitemregister" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.870000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expenseitemregister" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expensetransaction" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.904000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expensetransaction" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expensetransaction" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.937000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expensetransaction" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expensetransactionitem" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:58.970000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expensetransactionitem" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_expensetransactionitem" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.004000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_expensetransactionitem" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_incometransaction" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.036000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_incometransaction" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_incometransaction" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.069000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_incometransaction" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_measure" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.104000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_measure" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_measure" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.136000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_measure" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_paymentobject" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.171000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_paymentobject" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_paymentobject" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.204000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_paymentobject" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_poregister" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.239000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_poregister" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_poregister" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.276000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_poregister" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_potype" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.311000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_potype" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_potype" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.347000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_potype" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_supplier" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.381000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_supplier" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_supplier" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.415000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_supplier" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_transactionstatus" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.450000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_transactionstatus" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_transactionstatus" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.486000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_transactionstatus" ALTER COLUMN "last_edited_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_transfertransaction" ADD COLUMN "creation_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.522000+00:00'::timestamptz NOT NULL;
ALTER TABLE "cashapp_models_transfertransaction" ALTER COLUMN "creation_datetime" DROP DEFAULT;
ALTER TABLE "cashapp_models_transfertransaction" ADD COLUMN "last_edited_datetime" timestamp with time zone DEFAULT '2016-05-04T10:55:59.557000+00:00'::timestamptz NOT NULL;
